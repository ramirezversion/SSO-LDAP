<?php
  ...
  if (isset($_POST['user']) && isset($_POST['password'])) {
        ...
        $host= '192.168.10.173';
        $port= 636; //LDAP port 389// SSL: 636
        ...
        if ($bind){
            $newbind = ldap_bind( $conn, "cn=".$user.",ou=usuarios,dc=mpcs,dc=local", $password );
            if ($newbind) {
...
<html lang="en">
  ...
  <body>
    ...
    <div style="width:40%" class="container">
      ...
      <form class="form-signin" method="post" action="./authentication_lan_ldaps.php">
